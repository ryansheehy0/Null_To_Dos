...
export default function BoardView(){
  ...
  return (
    <div
      className={tm("w-[calc(100vw-var(--cardHeight))] overflow-auto h-screen bg-lightText dark:bg-gradient-to-br from-blue-600 to-fuchsia-500 absolute top-0 right-0 flex justify-start",
